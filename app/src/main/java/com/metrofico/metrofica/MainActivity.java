package com.metrofico.metrofica;
...
import com.metrofico.R;
import com.metrofico.metrofica.canbus.CanbusMsgSender;
import com.metrofico.metrofica.canbus.CanbusMsgServiceSwm;
import com.metrofico.metrofica.log.LogMessage;
...
public class MainActivity extends AppCompatActivity {
   ...
   /*private BroadcastReceiver logReceiver = new BroadcastReceiver() {
    ...
    protected void onResume() {
        super.onResume();
//        EventBus.getDefault().register(this);
        // LocalBroadcastManager.getInstance(this).registerReceiver(logReceiver, new IntentFilter("com.metrofico.LOG_UPDATE_SWM"));
    }
