package com.metrofico.metrofica.canbus;
...
import com.metrofico.metrofica.canbus.config.CanbusConfig;
import com.metrofico.metrofica.canbus.interfaces.MsgMgrInterface;
import com.metrofico.metrofica.canbus.msg_mgr.MsgMgrFactory;
import com.metrofico.metrofica.canbus.util.ContextUtil;
import com.metrofico.metrofica.canbus.util.SharePreUtil;
import com.metrofico.metrofica.cantype.CanTypeUtil;
import com.metrofico.metrofica.log.LoggerUI;
import com.metrofico.metrofica.proxy.mcu.core.IMCUCanBoxControlListener;
import com.metrofico.metrofica.proxy.mcu.core.MCUMainManager;
...
public class CanbusMsgServiceSwm extends Service {
    ...
    public CanbusMsgServiceSwm() {
        mHandlerThread = new HandlerThread("metrofico.canbusinfo.msgservice");
