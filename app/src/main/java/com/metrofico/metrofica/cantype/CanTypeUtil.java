...
import com.metrofico.metrofica.cantype.id.CanType0;
...
public final class CanTypeUtil {
    ...
    public final CanTypeBase getCanType(int i) {
        try {
            Object newInstance = Class.forName("com.metrofico.metrofica.cantype.id.CanType" + i).newInstance();
            Intrinsics.checkNotNull(newInstance, "null cannot be cast to non-null type com.metrofico.metrofica.cantype.CanTypeBase");
