...
public final class CanTypeUtil {
    ...
    public final CanTypeBase getCanType(int i) {
        try {
            Object newInstance = Class.forName("com.hzbhd.cantype.id.CanType" + i).newInstance();
            Intrinsics.checkNotNull(newInstance, "null cannot be cast to non-null type com.hzbhd.cantype.CanTypeBase");
